...
Component({
  ...
  methods: {
    ...
    selectleft: function (e) {
      ...
      var selectFirstLevelId=e.target.dataset.model.id;
      this.setData({
        dropDownMenuDataFirstRight: model==null?"":model,
        select1: selectedId,
        select2: '',
        selectFirstLevelId:selectFirstLevelId
      })
      if (model == null || model.length == 0) {
        this.closeHyFilter();
        this.triggerEvent("selectedItem", { index: this.data.shownavindex, selectedId: selectedId, selectedTitle: selectedTitle,selectFirstLevelId:this.data.selectFirstLevelId })
      }
    },
